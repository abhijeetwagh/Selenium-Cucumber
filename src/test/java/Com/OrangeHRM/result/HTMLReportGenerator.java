...
public class HTMLReportGenerator {
	...
	{
		report=new ExtentReports(ResultHTMLFilePath,true,NetworkMode.OFFLINE);
	...
	{
		logger = new ExtentTest("F:\\Orange_HRM.html", "Login Functionality");
	...
	/*public static void main(String[] args) throws UnknownHostException {
		TestSuiteStart("F:\\SmokeTest.html", "Abhijeet");
		TestCaseStart("user is successfully logged in", "Login OrangeHRM");
		TestCaseEnd();
		TestSuiteEnd();
